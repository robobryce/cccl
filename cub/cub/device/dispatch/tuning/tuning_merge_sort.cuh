...
struct MergeSortPolicy
{
  ...
  [[nodiscard]] _CCCL_API constexpr friend bool operator==(const MergeSortPolicy& lhs, const MergeSortPolicy& rhs)
  {
...
struct policy_selector
{
  ...
  [[nodiscard]] _CCCL_API constexpr auto operator()(::cuda::compute_capability) const -> MergeSortPolicy
  {
    // from SM60
...
{
  [[nodiscard]] _CCCL_API constexpr auto operator()(::cuda::compute_capability cc) const -> MergeSortPolicy
  {
