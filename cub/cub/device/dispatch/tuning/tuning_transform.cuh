...
struct TransformPolicy
{
  ...
  [[nodiscard]] _CCCL_API constexpr friend bool operator==(const TransformPolicy& lhs, const TransformPolicy& rhs)
  {
...
struct policy_selector
{
  ...
  [[nodiscard]] _CCCL_API constexpr auto operator()(::cuda::compute_capability cc) const -> TransformPolicy
  {
